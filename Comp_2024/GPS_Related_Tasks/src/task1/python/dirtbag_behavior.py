...
def callback(msg, node):
    ...
    logger.info("Received latitude information: {latitude}")
    logger.info("Received longitude information: {longitude}")
...
def main():
    ...
    global image_net, exit_signal, run_signal, detections, subscription, latitude
