...
class ZedObjects:
	...
	def detect_buoys(self):
		...
		for obj in self.objects.object_list:
			...
			elif (str(obj.raw_label) == "6") and (obj.tracking_state == sl.OBJECT_TRACKING_STATE.OK):
				self.green_plus_list.append(obj)
				self.green_plus_detected = True
			elif (str(obj.raw_label) == "7") and (obj.tracking_state == sl.OBJECT_TRACKING_STATE.OK):
			...
			elif (str(obj.raw_label) == "10") and (obj.tracking_state == sl.OBJECT_TRACKING_STATE.OK):
				self.red_plus_list.append(obj)
				self.red_plus_detected = True
			elif (str(obj.raw_label) == "11") and (obj.tracking_state == sl.OBJECT_TRACKING_STATE.OK):
