...
static size_t _BenchmarkStatsStamped__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_zed_topic_benchmark_interfaces__msg__BenchmarkStatsStamped(
    full_bounded, 0);
}
