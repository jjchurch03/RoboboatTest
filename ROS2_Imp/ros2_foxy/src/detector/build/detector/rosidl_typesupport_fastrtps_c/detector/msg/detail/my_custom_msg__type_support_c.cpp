...
#include "detector/msg/detail/my_custom_msg__rosidl_typesupport_fastrtps_c.h"
...
using _MyCustomMsg__ros_msg_type = detector__msg__MyCustomMsg;
...
size_t get_serialized_size_detector__msg__MyCustomMsg(
  const void * untyped_ros_message,
...
static uint32_t _MyCustomMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_detector__msg__MyCustomMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_detector
size_t max_serialized_size_detector__msg__MyCustomMsg(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_detector__msg__MyCustomMsg(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, detector, msg, MyCustomMsg)() {
