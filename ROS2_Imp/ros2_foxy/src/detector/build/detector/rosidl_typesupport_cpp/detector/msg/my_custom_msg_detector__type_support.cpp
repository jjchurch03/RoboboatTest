...
static const _MyCustomMsgDetector_type_support_symbol_names_t _MyCustomMsgDetector_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, detector, msg, MyCustomMsgDetector)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, detector, msg, MyCustomMsgDetector)),
  }
};
...
{
  return &::detector::msg::rosidl_typesupport_cpp::MyCustomMsgDetector_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, detector, msg, MyCustomMsgDetector)() {
  return get_message_type_support_handle<detector::msg::MyCustomMsgDetector>();
}
