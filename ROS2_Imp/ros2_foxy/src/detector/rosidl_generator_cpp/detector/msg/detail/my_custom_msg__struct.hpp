...
#ifndef DETECTOR__MSG__DETAIL__MY_CUSTOM_MSG__STRUCT_HPP_
#define DETECTOR__MSG__DETAIL__MY_CUSTOM_MSG__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__detector__msg__MyCustomMsg __attribute__((deprecated))
#else
# define DEPRECATED__detector__msg__MyCustomMsg __declspec(deprecated)
#endif
...
struct MyCustomMsg_
{
  ...
  // pointer types
  using RawPtr =
    detector::msg::MyCustomMsg_<ContainerAllocator> *;
  using ConstRawPtr =
    const detector::msg::MyCustomMsg_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<detector::msg::MyCustomMsg_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<detector::msg::MyCustomMsg_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      detector::msg::MyCustomMsg_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<detector::msg::MyCustomMsg_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<detector::msg::MyCustomMsg_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<detector::msg::MyCustomMsg_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<detector::msg::MyCustomMsg_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__detector__msg__MyCustomMsg
    std::shared_ptr<detector::msg::MyCustomMsg_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__detector__msg__MyCustomMsg
    std::shared_ptr<detector::msg::MyCustomMsg_<ContainerAllocator> const>
...
using MyCustomMsg =
  detector::msg::MyCustomMsg_<std::allocator<void>>;
...
#endif  // DETECTOR__MSG__DETAIL__MY_CUSTOM_MSG__STRUCT_HPP_
