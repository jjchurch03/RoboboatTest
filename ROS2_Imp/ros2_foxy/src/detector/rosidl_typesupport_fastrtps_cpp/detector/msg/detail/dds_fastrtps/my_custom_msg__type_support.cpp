...
#include "detector/msg/detail/my_custom_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const detector::msg::MyCustomMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  detector::msg::MyCustomMsg & ros_message)
{
  // Member: frame_id
  cdr >> ros_message.frame_id;
...
{
  auto typed_message =
    static_cast<const detector::msg::MyCustomMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<detector::msg::MyCustomMsg *>(
    untyped_ros_message);
...
{
  return &detector::msg::typesupport_fastrtps_cpp::_MyCustomMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, detector, msg, MyCustomMsg)() {
  return &detector::msg::typesupport_fastrtps_cpp::_MyCustomMsg__handle;
}
