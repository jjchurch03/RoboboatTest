...
#include "detector/msg/detail/my_custom_msg_detector__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const detector::msg::MyCustomMsgDetector *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<detector::msg::MyCustomMsgDetector *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MyCustomMsgDetector__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const detector::msg::MyCustomMsgDetector *>(
...
{
  return max_serialized_size_MyCustomMsgDetector(full_bounded, 0);
}

static message_type_support_callbacks_t _MyCustomMsgDetector__callbacks = {
  "detector::msg",
  "MyCustomMsgDetector",
...
static rosidl_message_type_support_t _MyCustomMsgDetector__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MyCustomMsgDetector__callbacks,
...
{
  return &detector::msg::typesupport_fastrtps_cpp::_MyCustomMsgDetector__handle;
}
