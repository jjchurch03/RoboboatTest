...
#include "main_control/msg/detail/my_custom_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "main_control/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _MyCustomMsg__ros_msg_type = main_control__msg__MyCustomMsg;

static bool _MyCustomMsg__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MyCustomMsg__ros_msg_type * ros_message = static_cast<const _MyCustomMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: frame_id
  {
...
static bool _MyCustomMsg__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _MyCustomMsg__ros_msg_type * ros_message = static_cast<_MyCustomMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: frame_id
  {
    std::string tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_main_control
size_t get_serialized_size_main_control__msg__MyCustomMsg(
  const void * untyped_ros_message,
...
static uint32_t _MyCustomMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_main_control__msg__MyCustomMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_main_control
size_t max_serialized_size_main_control__msg__MyCustomMsg(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _MyCustomMsg__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_main_control__msg__MyCustomMsg(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MyCustomMsg = {
  "main_control::msg",
  "MyCustomMsg",
  _MyCustomMsg__cdr_serialize,
  _MyCustomMsg__cdr_deserialize,
  _MyCustomMsg__get_serialized_size,
  _MyCustomMsg__max_serialized_size
};

static rosidl_message_type_support_t _MyCustomMsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MyCustomMsg,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, main_control, msg, MyCustomMsg)() {
  return &_MyCustomMsg__type_support;
}
