...
static const _MyCustomMsgMC_type_support_symbol_names_t _MyCustomMsgMC_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, main_control, msg, MyCustomMsgMC)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, main_control, msg, MyCustomMsgMC)),
  }
};
...
{
  return &::main_control::msg::rosidl_typesupport_cpp::MyCustomMsgMC_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, main_control, msg, MyCustomMsgMC)() {
  return get_message_type_support_handle<main_control::msg::MyCustomMsgMC>();
}
