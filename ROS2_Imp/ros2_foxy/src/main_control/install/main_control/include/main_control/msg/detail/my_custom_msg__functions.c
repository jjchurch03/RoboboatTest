...
main_control__msg__MyCustomMsg__init(main_control__msg__MyCustomMsg * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->frame_id)) {
    main_control__msg__MyCustomMsg__fini(msg);
    return false;
  }
  // object_classes
...
main_control__msg__MyCustomMsg__create()
{
  ...
  main_control__msg__MyCustomMsg * msg = (main_control__msg__MyCustomMsg *)allocator.allocate(sizeof(main_control__msg__MyCustomMsg), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(main_control__msg__MyCustomMsg));
  bool success = main_control__msg__MyCustomMsg__init(msg);
  if (!success) {
...
main_control__msg__MyCustomMsg__Sequence__init(main_control__msg__MyCustomMsg__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  main_control__msg__MyCustomMsg * data = NULL;

  if (size) {
    data = (main_control__msg__MyCustomMsg *)allocator.zero_allocate(size, sizeof(main_control__msg__MyCustomMsg), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = main_control__msg__MyCustomMsg__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        main_control__msg__MyCustomMsg__fini(&data[i - 1]);
      }
...
main_control__msg__MyCustomMsg__Sequence__fini(main_control__msg__MyCustomMsg__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      main_control__msg__MyCustomMsg__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  main_control__msg__MyCustomMsg__Sequence * array = (main_control__msg__MyCustomMsg__Sequence *)allocator.allocate(sizeof(main_control__msg__MyCustomMsg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = main_control__msg__MyCustomMsg__Sequence__init(array, size);
  if (!success) {
...
main_control__msg__MyCustomMsg__Sequence__destroy(main_control__msg__MyCustomMsg__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    main_control__msg__MyCustomMsg__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
main_control__msg__MyCustomMsg__Sequence__are_equal(const main_control__msg__MyCustomMsg__Sequence * lhs, const main_control__msg__MyCustomMsg__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!main_control__msg__MyCustomMsg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  main_control__msg__MyCustomMsg__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(main_control__msg__MyCustomMsg);
    main_control__msg__MyCustomMsg * data =
      (main_control__msg__MyCustomMsg *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!main_control__msg__MyCustomMsg__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          main_control__msg__MyCustomMsg__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!main_control__msg__MyCustomMsg__copy(
