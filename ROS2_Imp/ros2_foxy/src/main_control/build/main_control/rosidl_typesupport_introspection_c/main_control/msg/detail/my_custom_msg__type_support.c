...
#include <stddef.h>
#include "main_control/msg/detail/my_custom_msg__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  main_control__msg__MyCustomMsg__init(message_memory);
}

void MyCustomMsg__rosidl_typesupport_introspection_c__MyCustomMsg_fini_function(void * message_memory)
{
  main_control__msg__MyCustomMsg__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember MyCustomMsg__rosidl_typesupport_introspection_c__MyCustomMsg_message_member_array[6] = {
  {
    ...
    offsetof(main_control__msg__MyCustomMsg, frame_id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(main_control__msg__MyCustomMsg, object_classes),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(main_control__msg__MyCustomMsg, object_scores),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(main_control__msg__MyCustomMsg, object_bounding_boxes),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(main_control__msg__MyCustomMsg, object_positions),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(main_control__msg__MyCustomMsg, object_orientations),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MyCustomMsg__rosidl_typesupport_introspection_c__MyCustomMsg_message_members = {
  ...
  6,  // number of fields
  sizeof(main_control__msg__MyCustomMsg),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, main_control, msg, MyCustomMsg)() {
