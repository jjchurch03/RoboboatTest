...
void TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_init_function(
...
void TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_fini_function(void * message_memory)
{
  vectornav_msgs__msg__TimeGroup__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_message_member_array[12] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_message_members = {
  "vectornav_msgs__msg",  // message namespace
  "TimeGroup",  // message name
  12,  // number of fields
  sizeof(vectornav_msgs__msg__TimeGroup),
  TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_message_member_array,  // message members
  TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_init_function,  // function to initialize message memory (memory has to be allocated)
  TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_message_type_support_handle = {
  0,
  &TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vectornav_msgs, msg, TimeGroup)() {
  TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_message_member_array[8].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vectornav_msgs, msg, TimeUTC)();
  TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_message_member_array[11].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vectornav_msgs, msg, TimeStatus)();
  if (!TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_message_type_support_handle.typesupport_identifier) {
    TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &TimeGroup__rosidl_typesupport_introspection_c__TimeGroup_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
