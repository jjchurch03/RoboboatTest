...
void VpeStatus__rosidl_typesupport_introspection_c__VpeStatus_init_function(
...
void VpeStatus__rosidl_typesupport_introspection_c__VpeStatus_fini_function(void * message_memory)
{
  vectornav_msgs__msg__VpeStatus__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember VpeStatus__rosidl_typesupport_introspection_c__VpeStatus_message_member_array[9] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers VpeStatus__rosidl_typesupport_introspection_c__VpeStatus_message_members = {
  "vectornav_msgs__msg",  // message namespace
  "VpeStatus",  // message name
  9,  // number of fields
  sizeof(vectornav_msgs__msg__VpeStatus),
  VpeStatus__rosidl_typesupport_introspection_c__VpeStatus_message_member_array,  // message members
  VpeStatus__rosidl_typesupport_introspection_c__VpeStatus_init_function,  // function to initialize message memory (memory has to be allocated)
  VpeStatus__rosidl_typesupport_introspection_c__VpeStatus_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t VpeStatus__rosidl_typesupport_introspection_c__VpeStatus_message_type_support_handle = {
  0,
  &VpeStatus__rosidl_typesupport_introspection_c__VpeStatus_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vectornav_msgs, msg, VpeStatus)() {
  if (!VpeStatus__rosidl_typesupport_introspection_c__VpeStatus_message_type_support_handle.typesupport_identifier) {
    VpeStatus__rosidl_typesupport_introspection_c__VpeStatus_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &VpeStatus__rosidl_typesupport_introspection_c__VpeStatus_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
