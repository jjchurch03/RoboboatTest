...
static const _YOLOv5helper_type_support_symbol_names_t _YOLOv5helper_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, detector, msg, YOLOv5helper)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, detector, msg, YOLOv5helper)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, detector, msg, YOLOv5helper)() {
  return &::detector::msg::rosidl_typesupport_c::YOLOv5helper_message_type_support_handle;
}
