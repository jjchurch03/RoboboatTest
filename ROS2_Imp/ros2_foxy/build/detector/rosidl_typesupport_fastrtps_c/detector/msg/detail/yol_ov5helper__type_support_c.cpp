...
#include "detector/msg/detail/yol_ov5helper__rosidl_typesupport_fastrtps_c.h"
...
using _YOLOv5helper__ros_msg_type = detector__msg__YOLOv5helper;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _YOLOv5helper__ros_msg_type * ros_message = static_cast<const _YOLOv5helper__ros_msg_type *>(untyped_ros_message);
  // Field name: frame_id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _YOLOv5helper__ros_msg_type * ros_message = static_cast<_YOLOv5helper__ros_msg_type *>(untyped_ros_message);
  // Field name: frame_id
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_detector__msg__YOLOv5helper(
  const void * untyped_ros_message,
...
static uint32_t _YOLOv5helper__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_detector__msg__YOLOv5helper(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_detector
size_t max_serialized_size_detector__msg__YOLOv5helper(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_detector__msg__YOLOv5helper(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_YOLOv5helper = {
  "detector::msg",
  "YOLOv5helper",
...
static rosidl_message_type_support_t _YOLOv5helper__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_YOLOv5helper,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, detector, msg, YOLOv5helper)() {
  return &_YOLOv5helper__type_support;
}
