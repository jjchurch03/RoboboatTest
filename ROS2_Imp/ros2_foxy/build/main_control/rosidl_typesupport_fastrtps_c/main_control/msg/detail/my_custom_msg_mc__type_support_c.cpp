...
#include "main_control/msg/detail/my_custom_msg_mc__rosidl_typesupport_fastrtps_c.h"
...
using _MyCustomMsgMC__ros_msg_type = main_control__msg__MyCustomMsgMC;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MyCustomMsgMC__ros_msg_type * ros_message = static_cast<const _MyCustomMsgMC__ros_msg_type *>(untyped_ros_message);
  // Field name: frame_id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MyCustomMsgMC__ros_msg_type * ros_message = static_cast<_MyCustomMsgMC__ros_msg_type *>(untyped_ros_message);
  // Field name: frame_id
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_main_control__msg__MyCustomMsgMC(
  const void * untyped_ros_message,
...
static uint32_t _MyCustomMsgMC__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_main_control__msg__MyCustomMsgMC(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_main_control
size_t max_serialized_size_main_control__msg__MyCustomMsgMC(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_main_control__msg__MyCustomMsgMC(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MyCustomMsgMC = {
  "main_control::msg",
  "MyCustomMsgMC",
...
static rosidl_message_type_support_t _MyCustomMsgMC__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MyCustomMsgMC,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, main_control, msg, MyCustomMsgMC)() {
  return &_MyCustomMsgMC__type_support;
}
