...
class Metaclass_MyCustomMsgMC(type):
    """Metaclass of message 'MyCustomMsgMC'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('main_control')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'main_control.msg.MyCustomMsgMC')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__my_custom_msg_mc
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__my_custom_msg_mc
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__my_custom_msg_mc
            cls._TYPE_SUPPORT = module.type_support_msg__msg__my_custom_msg_mc
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__my_custom_msg_mc
...
class MyCustomMsgMC(metaclass=Metaclass_MyCustomMsgMC):
    """Message class 'MyCustomMsgMC'."""
