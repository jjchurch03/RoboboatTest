...
static PyMethodDef main_control__methods[] = {
  {NULL, NULL, 0, NULL}  /* sentinel */
};

static struct PyModuleDef main_control__module = {
  PyModuleDef_HEAD_INIT,
  "_main_control_support",
  "_main_control_doc",
  -1,  /* -1 means that the module keeps state in global variables */
  main_control__methods,
  NULL,
  NULL,
  NULL,
  NULL,
...
PyMODINIT_FUNC
PyInit_main_control_s__rosidl_typesupport_introspection_c(void)
{
  PyObject * pymodule = NULL;
  pymodule = PyModule_Create(&main_control__module);
  if (!pymodule) {
    return NULL;
  }
  int8_t err;
