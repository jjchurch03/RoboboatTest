...
{
  new (message_memory) main_control::msg::MyCustomMsg(_init);
}

void MyCustomMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<main_control::msg::MyCustomMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MyCustomMsg_message_member_array[6] = {
  {
    ...
    offsetof(main_control::msg::MyCustomMsg, frame_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(main_control::msg::MyCustomMsg, object_classes),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(main_control::msg::MyCustomMsg, object_scores),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(main_control::msg::MyCustomMsg, object_bounding_boxes),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(main_control::msg::MyCustomMsg, object_positions),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(main_control::msg::MyCustomMsg, object_orientations),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MyCustomMsg_message_members = {
  ...
  6,  // number of fields
  sizeof(main_control::msg::MyCustomMsg),
...
{
  return &::main_control::msg::rosidl_typesupport_introspection_cpp::MyCustomMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, main_control, msg, MyCustomMsg)() {
  return &::main_control::msg::rosidl_typesupport_introspection_cpp::MyCustomMsg_message_type_support_handle;
}
